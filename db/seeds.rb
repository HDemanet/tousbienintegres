...
# Coralie Damon
coralie = Candidate.create!(
  name: "Coralie Damon",
  country: :belgique,
  city: "Gembloux, province de Namur",
  position: 13,
  featured: true,
  photo_path: "team/coralie.jpg",
  bio: <<~HTML
   <p>Originaire de Poitiers, je suis en Belgique depuis bientôt 16 ans. Titulaire d’un doctorat en microbiologie de l’université de Lyon, j’ai décroché un postdoctorat à l’université de Gembloux Agro-Bio Tech, c’est ce qui nous a amené moi et mon compagnon en Belgique en 2010. Nous sommes tombés « amoureux » de la Belgique, de sa culture et de l’accueil des gens et nous avons décidé de nous y installer.</p>
   <p>Par la suite, j’ai entamé une reconversion professionnelle afin de travailler dans l’industrie pharmaceutique, secteur très porteur d’emploi en Belgique. A cette occasion, j’ai pu apprécier l’efficacité des aides à l’emploi belges, permettant d’accéder à des formations certifiantes, qui m’ont été un vrai tremplin vers l’emploi.</p>
   <p>Maman de 2 enfants, tous les 2 nés en Belgique, je suis très sensible aux enjeux actuels d’ordre écologiques et j’ai à cœur d’œuvrer pour un monde durable et de sensibiliser nos enfants sur ces sujets.</p>
   <p>Passionnée d’art et de musique, j’ai trouvé en la Belgique une terre d’accueil aussi pour mes hobbies, où j’ai pu pratiquer le chant chorale et l’académie des arts de Braine l’alleud.</p>
  HTML
)
puts "✅ Created: #{coralie.name}"

# Olivier Bertaud
olivier = Candidate.create!(
  name: "Olivier Bertaud",
  country: :belgique,
  city: "Gembloux, province de Namur",
  position: 22,
  featured: true,
  photo_path: "team/olivier.jpg",
  bio: <<~HTML
    <p>Je suis arrivé en Belgique fin 2010 après y avoir suivi ma compagne pour son travail. Originaire d’une commune rurale dans la Vienne, je suis passionnée par le domaine agricole depuis tout jeune et j’y ai consacré mes études. Les enjeux actuels qui touchent le monde agricole m’intéressent fortement (agriculture régénérative, circuits courts…). Il y a 20 ans, J’ai créé ma propre activité artisanale en lien avec le milieu agricole. J’ai depuis délocalisé cette activité en Belgique.</p>
    <p>Je suis papa de 2 enfants nés en Belgique. En 2016, avec ma compagne, nous avons choisi de nous y installer. Gembloux, une ville de taille humaine et proche de la campagne semblait être une ville idéalement située pour élever nos enfants ; l’accès à l’éducation et à différents points de culture y sont aisés.</p>
    <p>Mes enfants qui ont 10 et 7 ans me rappellent chaque jour que mon travail et mes actions ont des répercussions sur leur avenir. Dans un monde en plein changement, j’essaye de trouver un équilibre entre l’entreprenariat et la vie de famille. Aussi j’accorde beaucoup d’importance sur mes façons de produire et de consommer et j’essaye d’éduquer ces valeurs à mes enfants.</p>
    <p>Je pense que mon parcours est un exemple d’intégration à la vie belge.</p>
  HTML
)
